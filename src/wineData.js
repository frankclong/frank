const wine_dir = "wines";
export const WINES = [
    {
        "image" : "./" + wine_dir + "/torbreck-2021.jpg",
    ...
    {
        "image" : "./" + wine_dir + "/campo-viejo-2021.jpg",
    ...
    {
        "image" : "./" + wine_dir + "/brouilly-2018.jpg",
    ...
    {
        "image" : "./" + wine_dir + "/carnivor-zin-2020.jpeg",
